...
This is the codebase for the code, drivers, vision control, and logic that the robot arm uses to operate. The arm runs using 2 NEMA 17 stepper motors and a NEMA 23, all driven by 3 TMC2240 driver + motion controller chips. The microcontroller is a STM32L4A6ZG (144 pin).
...
[PCB Schematic](images/pcbschematic1.png)
[PCB Schematic](images/pcbschematic2.png)
[PCB Schematic](images/pcbschematic3.png)
[PCB Schematic](images/pcbschematic4.png)
