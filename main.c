...
//    float fx, fy, fz;
//    arm_fk(0.0f, 1.5707963f, -1.5707963f, &fx, &fy, &fz);   /* +pi/2, -pi/2 */
//    (void)fx; (void)fy; (void)fz;   /* expect fx≈245, fy≈0, fz≈315 <- home position */
...
static void MX_SPI1_Init(void)
{
  ...
  __HAL_SPI_ENABLE(&hspi1);   /* SCK parks at idle-high before any CS toggling */
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, M1_CS_Pin|M2_CS_Pin|M3_CS_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, M1_DIR_Pin|M2_DIR_Pin|M3_DIR_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, M1_EN_Pin|M2_EN_Pin|M3_EN_Pin, GPIO_PIN_SET);

  /*Configure GPIO pins : M1_DIAG0_Pin M2_DIAG0_Pin */
  GPIO_InitStruct.Pin = M1_DIAG0_Pin|M2_DIAG0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : M1_DIAG1_Pin M2_DIAG1_Pin M3_DIAG1_Pin */
  GPIO_InitStruct.Pin = M1_DIAG1_Pin|M2_DIAG1_Pin|M3_DIAG1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : M1_CS_Pin M2_CS_Pin M3_CS_Pin */
  ...
  /*Configure GPIO pins : M1_DIR_Pin M2_DIR_Pin M3_DIR_Pin M1_EN_Pin
                           M2_EN_Pin M3_EN_Pin */
  GPIO_InitStruct.Pin = M1_DIR_Pin|M2_DIR_Pin|M3_DIR_Pin|M1_EN_Pin
                          |M2_EN_Pin|M3_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pin : M3_DIAG0_Pin */
  GPIO_InitStruct.Pin = M3_DIAG0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(M3_DIAG0_GPIO_Port, &GPIO_InitStruct);
